...
def main(args):
    ...
    # Setup audio
    audio_transcriber.setup_audio(model_name=model,
    ...
    transcriber_publisher = rospy.Publisher(
        'audio_transcription',
        String,
        queue_size=1
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--record_timeout", default=0.1,
                        help="How real-time the recording is in seconds.", type=float)
    parser.add_argument("--phrase_timeout", default=0.5,
                        help="How much empty space between recordings before we "
                             "consider it a new line in the transcription.", type=float)
    if 'linux' in platform:
        parser.add_argument("--default_microphone", default='USB PnP Audio Device: Audio',
