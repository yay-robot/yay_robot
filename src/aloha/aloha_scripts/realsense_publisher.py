...
camera_sns = ['218622270323', '128422270492', '130322273656', '128422272271']
...
if len(devices) != len(camera_names):
    raise Exception("Number of devices doesn't match number of camera names")
...
for sn, pipe, cfg in zip(camera_sns, pipes, cfgs):
    print(sn)
