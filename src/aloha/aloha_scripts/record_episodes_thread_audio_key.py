...
Example usage: 
$ python3 record_episodes_thread_audio_key.py --task_name aloha_task --num_episodes 3
'''
...
option = 0
MEMORY_BUFFER_MB = 500  # The amount of memory to ensure remains free
AUDIO = False # Temp flag, disable audio for debugging
